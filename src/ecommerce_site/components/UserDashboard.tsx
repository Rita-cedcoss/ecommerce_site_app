...
const UserDashboard = () => {
  ...
  const addToCart = (ind: number) => {
    ...
    console.log(state);
    JSON.parse(localStorage.getItem("signUpData") || "").map(
      (item: any, i: number) => {
        if (
          ...
          dispatch(
            addCart({
              obj: state.EcommerceReducer.searchArr[ind],
              index: i,
              prodIndex: ind,
            })
          );
                  ...
                  <div className="item1 pb-5">
                    ...
                    <div className="productItem_content ps-2 border-top">
                      ...
                      <div className="d-flex justify-content-between">
                        <span
                          className="bg-primary rounded text me-3  ps-2 pe-2 pt-2 pb-2 text-light"
                          onClick={() => addToCart(i)}
                        >
                          Add To Cart
                        </span>
